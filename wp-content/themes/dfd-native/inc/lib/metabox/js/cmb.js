...
//								}
			...
			var $metaBoxes				= $('#normal-sortables')
												.children('.postbox:not(#wpb_visual_composer):not(#vcwb_visual_composer):not(#woocommerce-product-data):not(#wc-memberships-product-memberships-data):not(#wpseo_meta):not(#the_grid_item_formats):not(.acf-postbox):not(#pagebilder_content):not(#custom_content_editor)')
												.clone(),
				$advancedContainer		= $('#advanced-sortables');

			$('#normal-sortables').children('.postbox:not(#wpb_visual_composer):not(#vcwb_visual_composer):not(#woocommerce-product-data):not(#wc-memberships-product-memberships-data):not(#wpseo_meta):not(#the_grid_item_formats):not(.acf-postbox):not(#pagebilder_content):not(#custom_content_editor)').remove();
