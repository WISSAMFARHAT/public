...
if (isset($tooltip_text_color) && $tooltip_text_color != ''){
	$css_rules .= '#' . esc_js($unique_id) . ' .gm-style .CustomStyleInfoWin .map-content {color: ' . esc_attr($tooltip_text_color) . ';}';
	$css_rules .= '#' . esc_js($unique_id) . ' .gm-style .CustomStyleInfoWin .map-title {color: ' . esc_attr($tooltip_text_color) . ';}';
	$css_rules .= '#' . esc_js($unique_id) . ' .gm-style-iw div div {color: ' . esc_attr($tooltip_text_color) . ';}';
	$css_rules .= '#' . esc_js($unique_id) . ' .gm-style-iw div .map-title {color: ' . esc_attr($tooltip_text_color) . ';}';
	$css_rules .= '#' . esc_js($unique_id) . ' .gm-style-iw div .map-content {color: ' . esc_attr($tooltip_text_color) . ';}';
 ...
 * Typography
 */
$title_options = _dfd_parse_text_shortcode_params($title_font_options, 'widget-title', $title_google_fonts, $title_custom_fonts, true);
if(isset($title_options["style"]) && !empty($title_options["style"])) {
